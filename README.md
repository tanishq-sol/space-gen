...
- [x] 3D scene viewer with object visualization
- [x] Gemini-powered scene understanding
- [x] Natural language chat for design edits
- [x] Hero image generation (photorealistic redesigns)
- [x] Reference image upload + analysis
- [x] Before/after comparison slider
- [x] 3 design variant generation
- [x] Client presentation mode
- [x] Local video import and reconstruction job progress
- [x] OpenCV keyframe extraction wired to a FastAPI job endpoint
- [x] Nerfstudio `splatfacto` training/export worker when local tools are installed

## Tech Stack

| Layer | Technology |
|-------|-----------|
| Frontend | Next.js 15, React Three Fiber, Tailwind CSS, Zustand |
| Backend | FastAPI, Python 3.12, google-genai SDK |
| AI | Gemini 2.5 Flash / Pro (reasoning + image gen) |
| 3D | Three.js scene graph preview + Nerfstudio Gaussian Splat export |

## Team

- **Person 1 (AI/Backend)**: Gemini integration, API, scene analysis, image generation
- **Person 2 (3D/CV)**: 3D viewer, object selection, reconstruction
- **Person 3 (Frontend)**: UI, chat, before/after, presentation mode
